...
class cfg(cfg_common, cfg_dataset_default, cfg_model_mvad):
	...
	def __init__(self):
		...
		self.lr = 0.005 * self.batch_train * 5 / 16
		...
		self.vis = False
		self.vis_dir = 'realiad_mvad'

		# ==> data
		self.data.type = 'RealIAD_MV'
